...
const StorePolicy = () => {
  return (
    <div className="relative">
      ...
      <Header />
      <div className="mt-[5.5rem] mx-[450px] displayCenter space-y-10">
        <div className="displayCenter space-y-5">
          <h3 className="text-h3 font-extra italic">Customer Care</h3>
          <p className="text-normal text-center font-main">
        ...
        <div className="displayCenter space-y-5 ">
          <h3 className="text-h3 font-extra italic">Privacy & Safety</h3>
          <p className="text-normal text-center font-main">
        ...
        <div className="displayCenter space-y-5 ">
          <h3 className="text-h3 font-extra italic">Wholesale Inquiries</h3>
          <p className="text-normal text-center font-main">
        ...
        <div className="displayCenter ">
          <h3 className="text-h3 font-extra italic">Payment Methods</h3>
          <p className="mt-5 text-normal text-center font-main">- Credit / Debit Cards</p>
          <p className="text-normal text-center font-main">- PAYPAL </p>
          <p className="text-normal text-center font-main">
            - Offline Payments
          </p>
        </div>
